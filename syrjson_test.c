...
#define TEST_STRING(expect,json)\
	do{\
		...
		syr_init(&v);\
		EXPECT_EQ_INT(SYR_PARSE_OK,syr_parse(&v,json));\
		EXPECT_EQ_INT(SYR_STRING,syr_get_type(&v));\
		EXPECT_EQ_STRING(expect,syr_get_string(&v),syr_get_string_length(&v));\
		syr_free(&v);\
		}while(0)
...
static void test_parse_missing_quotation_mark() {
    TEST_ERROR(SYR_PARSE_MISS_QUOTATION_MARK, "\"");
    TEST_ERROR(SYR_PARSE_MISS_QUOTATION_MARK, "\"abc");
}

static void test_parse_invalid_string_escape() {
    TEST_ERROR(SYR_PARSE_INVALID_STRING_ESCAPE, "\"\\v\"");
    TEST_ERROR(SYR_PARSE_INVALID_STRING_ESCAPE, "\"\\'\"");
    TEST_ERROR(SYR_PARSE_INVALID_STRING_ESCAPE, "\"\\0\"");
    TEST_ERROR(SYR_PARSE_INVALID_STRING_ESCAPE, "\"\\x12\"");
}

static void test_parse_invalid_string_char() {
    TEST_ERROR(SYR_PARSE_INVALID_STRING_CHAR, "\"\x01\"");
    TEST_ERROR(SYR_PARSE_INVALID_STRING_CHAR, "\"\x1F\"");
}

static void test_access_null() {
    syr_value v;
    syr_init(&v);
    syr_set_string(&v, "a", 1);
    syr_set_null(&v);
    EXPECT_EQ_INT(SYR_NULL, syr_get_type(&v));
    syr_free(&v);
}
...
static void test_access_boolean() {
    ...
    syr_set_string(&v, "a", 1);
    syr_set_boolean(&v, 1);
    EXPECT_TRUE(syr_get_boolean(&v));
    syr_set_boolean(&v, 0);
    EXPECT_FALSE(syr_get_boolean(&v));
    syr_free(&v);
}
...
static void test_access_number() {
    ...
    syr_init(&v);
    syr_set_string(&v, "a", 1);
    syr_set_number(&v, 1234.5);
    EXPECT_EQ_DOUBLE(1234.5, syr_get_number(&v));
    syr_free(&v);
}
...
static void test_access_string() {
    ...
    syr_init(&v);
    syr_set_string(&v, "", 0);
    EXPECT_EQ_STRING("", syr_get_string(&v), syr_get_string_length(&v));
    syr_set_string(&v, "Hello", 5);
    EXPECT_EQ_STRING("Hello", syr_get_string(&v), syr_get_string_length(&v));
    syr_free(&v);
}
